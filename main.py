...
app = FastAPI(title="Gmail OAuth Backend", lifespan=lifespan, version="1.0.2", description="Backend para autenticación OAuth con Gmail, con verificación de usuario en el endpoint de inicio y manejo de conexiones de usuarios.")
