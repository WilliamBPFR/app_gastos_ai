...
from . import forgot_password_router, auth_router, user_router, dashboard_router, categories_router, transactions_router, accounts_router
...
web_app_router.include_router(accounts_router.router)